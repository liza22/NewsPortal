...
<div class="w3-display-container">
    <div class="w3-card w3-panel w3-center w3-padding w3-pale-yellow w3-display-topmiddle w3-third">
        ...
        <form:form method="post" action="add" modelAttribute="news"
                 class="w3-selection">
            <h3><spring:message code="label.addnews"/></h3>
            <form:label path="title">
                <spring:message code="label.title"/>
            </form:label>
            <form:input path="title" maxlength="40" class="w3-input w3-border w3-round-large"/>
            ...
            <form:select path="category" class="w3-input w3-border w3-round-large">
                <form:options items="${categoriesList}" itemValue="id" itemLabel="name"/>
            </form:select>
            <input type="submit" value="<spring:message code="label.addnews" />"
